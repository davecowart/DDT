<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Blueprint.Master"
	Inherits="System.Web.Mvc.ViewPage<DDT.Models.Character>" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ScriptContent" runat="server">
	...
	<script src="<%=this.ResolveUrl("~/Scripts/create.js")%>" type="text/javascript"></script>
</asp:Content>
